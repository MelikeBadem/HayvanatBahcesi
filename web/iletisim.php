...
<head>
    ...
    <style>
        ...
        .banner {
            ...
            padding: 20px 0; /* İsteğe bağlı olarak padding ayarı */
...
<section class="banner">
    <div class="container d-flex justify-content-between align-items-center text-white position-relative">
        <div>
            <h2>Hoş Geldiniz!</h2>
            <p>Bu website için kaynak kodlarımızın linki aşağıdadır.</p>
        </div>
            ...
            <div class="info">
                <div class="animal-info">
                    <div class="animal-image">
                        <img id="github" src="github.jpg" alt="github" onclick="nextImage()">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    var images = ["github.jpg", "github.jpg", "github.jpg"];
