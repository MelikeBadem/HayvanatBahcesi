...
<head>
    ...
    <style>
        ...
        .animal-info .animal-image img {
            width: 100%;
            max-width: 600px; /* maksimum genişlikz */
            height: 400px; 
...
<section class="banner">
    <div class="container d-flex justify-content-between align-items-center text-white position-relative">
        <div>
            <h2>Hoş Geldiniz!</h2>
            <p>Hayvanat bahçemizdeki doğal yaşamın keyfini çıkarın.</p>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="info"style="height: 460px;">
                <h2>Hayvanat Bahçesi Hakkında</h2>
            ...
            <div class="info">
                <div class="animal-info">
                    <div class="animal-image">
                        <img id="animalImage" src="zoo1.jpg" alt="Hayvanat Bahçesi" onclick="nextImage()">
                    </div>
                </div>
            </div>
        </div>
